...
#
#
# class CCULib(QObject):
#     statusSignal = pyqtSignal(str)
#     deviceCounted = pyqtSignal(int)
#
#     def __init__(self):
#         super(CCULib, self).__init__()
...
#             self.statusSignal.emit("Error Connecting to the CCULib server")
#
#         print(self.s.recv(1024))
#         time.sleep(1)
#         self.s.send(b'Init:"COM3"\n')
...
#         print(self.s.recv(1024), "Scanstate")
#         time.sleep(20)
#
...
#     #     time.sleep(1)
#
#     def settilt(self, port, tilt):  # phase r = 1, y = 2, b = 3 & tilt 1° = 10, 14°=140
#         """
...
#         phase = 1
#         print(type(tilt))
#         cmd = bytes("SetTilt:{},{},{}\n".format(port, phase, tilt), encoding="utf-8")
#         print(cmd)
...
#         print(msgdec[3:])
#
#     def gettilt(self, port, phase=None):  # phase r = 1, y = 2, b = 3 & tilt 1° = 10, 14°=140
#         """
#         Port is inverted from ALDC R1 = 2, R2 = 1
#         :return:
#         """
...
#         print(msg)
#         msgdec = msg.decode()
#         print(msgdec, "degree tilt")
#         print(msgdec[3:])
#
#     def getcommandresults(self):
#         self.s.send(b'GetCommandResult:65536\n')
#         msg = self.s.recv(1024)
#         msgdec = msg.decode()
#         return msgdec
#
